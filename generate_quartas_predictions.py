"""
Gera previsoes para as 4 Quartas de Final com Elo atualizado por:
  - 48 resultados da fase de grupos
  - 16 resultados da Rodada de 32
  -  8 resultados das Oitavas de Final

Penaltis -> placar do tempo regulamentar + prorrogacao (empate para o Elo).
"""
...
ALL_WC_RESULTS = [
    ...
    ("Brazil",             "Japan",              2, 1),
    ("Paraguay",           "Germany",            1, 1),   # 4-3 pens
    ("Morocco",            "Netherlands",        1, 1),   # 3-2 pens
    ...
    ("Argentina",          "Egypt",              3, 2),
    ("Colombia",           "Switzerland",        0, 0),   # 4-3 pens para Suica
]

QUARTAS = [
    {"id": "R8-01", "date": "2026-07-09", "time_brt": "17:00",
     "team_a": "France",    "team_b": "Morocco",
     "venue": "Gillette Stadium, Boston"},
    {"id": "R8-02", "date": "2026-07-10", "time_brt": "16:00",
     "team_a": "Spain",     "team_b": "Belgium",
     "venue": "SoFi Stadium, Los Angeles"},
    {"id": "R8-03", "date": "2026-07-11", "time_brt": "18:00",
     "team_a": "Norway",    "team_b": "England",
     "venue": "Hard Rock Stadium, Miami"},
    {"id": "R8-04", "date": "2026-07-11", "time_brt": "21:00",
...
def run() -> None:
    ...
    predictions = []
    print(f"\nGerando previsoes para os 4 jogos das Quartas de Final...\n")
    ...
    for m in QUARTAS:
        ...
        result = predictor.predict(ta, tb, team_a, team_b,
                                   tournament_phase_name="Quartas de Final")
    ...
    output = {
        ...
        "_modelo":            "Elo(~53%) + Poisson(~47%) — Elo atualizado com 72 resultados reais (grupos + R32 + oitavas)",
        "_resultados_usados": n,
        "jogos":              predictions,
    }

    dest = ROOT / "data" / "previsoes_quartas.json"
